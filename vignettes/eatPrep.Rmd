...
As a reminder, here is an overview over the different **missing types** the IQB uses and their standard values: 
...
types <- data.frame(Code = code, Label = label, Abbr = kurz, Explanation = beschreibung, "Standard Recode Values" = recode_value)
names(types)[5] <- "Standard Recode Values"
kable(types)
```
