...
These are descriptive population density estimates. The plots do not compute uncertainty intervals, replicate-weight variances, or percentages between cuts. A density height is not itself a percentage of respondents.
