...
For more Information on how the different layers or `Input Tables` look like, please see the [Getting Started Vignette](getting_started.html).
...
![tbd: what are items and what are subitems ad what is going to be aggregated](images/cyclehire1.jpg)
...
But there are many more arguments that may need to consider. For more information see `?automateDataPreparation`.
