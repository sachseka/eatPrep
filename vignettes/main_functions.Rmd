...
Table columns have equal display width so that close or identical cuts do not cause percentage labels to overlap. With many cuts or a narrow plot, reduce `percentage_size` or increase the figure width.
