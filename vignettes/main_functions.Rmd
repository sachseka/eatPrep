...
`computeCutsIDM()` calculates cut scores for Item Descriptor Matching (IDM). The data set must contain item difficulty estimates and one or more numeric rater columns. The `boundaries` argument determines the requested cut scores, for example four boundaries for five performance levels.
