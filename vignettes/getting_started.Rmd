...
Optionally, you can specify how missing values should be aggregated (`aggregatemissings`), or which column names the returned data frame should have (`recodedData`). Type `?aggregateData` into your console to learn more. 
