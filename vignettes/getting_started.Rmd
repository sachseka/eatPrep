...
There are more arguments with default values which to you don't have to, but you can specify. 
...
Examples for the data frames `booklets`, `blocks`, `rotation` and `subunits` can be found via `inputList`. For more infomation type `?mnrCoding` into your console to learn more. 

```{r mnrCoding setup, eval=FALSE}
# Setup for mnrCoding()
