...
idm1 <- c("[computeCutsIDM()](main_functions.html#idm-cut-scores)", "computes cut scores and summary statistics for Item Descriptor Matching based on monotonized moving averages.")
