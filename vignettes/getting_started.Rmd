...
idm2 <- c("[plotCutsIDM()](main_functions.html#idm-cut-scores)", "plots the raw ratings, moving averages, monotonized curves, optional residual panels, and cut scores from `computeCutsIDM()`.")
